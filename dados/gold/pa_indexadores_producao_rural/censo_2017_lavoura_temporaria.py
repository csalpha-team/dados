"""Gold flow: pa_indexadores_producao_rural — Censo Agro 2017, lavoura temporária."""
...
from dados.gold.models.pa_indexadores_producao_rural import (
    PaIndexadoresLavouraTemporariaCenso2017,
)
...
TABLE = "lavoura_temporaria_censo_2017"
SILVER_SCHEMA = "al_ibge_censoagro"
SILVER_TABLE = "tbl_6957_2017"

MODEL = PaIndexadoresLavouraTemporariaCenso2017
NON_NUMERIC = {
