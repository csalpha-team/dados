"""Gold flow: pa_indexadores_producao_rural — PAM lavoura temporária."""
...
from dados.gold.models.pa_indexadores_producao_rural import (
    PaIndexadoresLavouraTemporariaPam,
)
...
TABLE = "lavoura_temporaria_pam"
SILVER_SCHEMA = "al_ibge_pam"
SILVER_TABLE = "lavoura_temporaria"

MODEL = PaIndexadoresLavouraTemporariaPam
NUMERIC_COLS = [
