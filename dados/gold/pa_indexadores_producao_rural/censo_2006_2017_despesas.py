"""Gold flow: pa_indexadores_producao_rural — Censo 2006+2017 despesas (UNION)."""
...
from dados.gold.models.pa_indexadores_producao_rural import (
    PaIndexadoresDespesasCenso2006_2017,
)
