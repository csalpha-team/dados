"""Gold flow: brasil_despesas_familiares — POF 2018 expenses by household setting.

Pass-through of silver ``br_ibge_pof.tbl_6970``. Duplicates the
``br_despesas_familiares`` output under a different schema name kept for
...
from dados.gold.models.brasil_despesas_familiares import (
    BrasilDespesasFamiliaresPof2018DespesasFamiliaresSituacaoDomicilio,
)
...
DATASET_ID = "brasil_despesas_familiares"
ZONE = "gold"
...
MODEL = BrasilDespesasFamiliaresPof2018DespesasFamiliaresSituacaoDomicilio
