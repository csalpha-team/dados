"""Gold flow: pa_servicos_industria_comercio — PAC commerce filtered to Pará."""
...
from dados.gold.models.pa_servicos_industria_comercio import (
    PaServicosIndustriaComercioPacComercio,
)
...
SILVER_DATASET = "br_ibge_pac"
SILVER_TABLE = "tbl_1407"

MODEL = PaServicosIndustriaComercioPacComercio
