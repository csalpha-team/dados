...
from dados.silver.models.al_ibge_censoagro import AlIbgeCensoagroTbl23372006
...
def flow() -> None:
    ...
    try:
        ...
        write_silver(TABLE, df, AlIbgeCensoagroTbl23372006); log.info("load.done", rows=len(df))
