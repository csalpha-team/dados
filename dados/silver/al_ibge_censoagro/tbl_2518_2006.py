...
def transform(df: pd.DataFrame) -> pd.DataFrame:
    ...
    df = fix_ibge_digits(
        ...
        ["id_municipio", "ano", "produto", "tipo_agricultura", "tipo_consumo_estocagem", "tipo_venda_entrega"],
...
def flow() -> None:
    ...
    try:
        ...
        write_silver(TABLE, df, AlIbgeCensoagroTbl25182006); log.info("load.done", rows=len(df))
