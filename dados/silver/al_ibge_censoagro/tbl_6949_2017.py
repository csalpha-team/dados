...
from dados.silver.models.al_ibge_censoagro import AlIbgeCensoagroTbl69492017
...
def flow() -> None:
    ...
    try:
        ...
        write_silver(TABLE, df, AlIbgeCensoagroTbl69492017); log.info("load.done", rows=len(df))
