"""Raw flow: BR diretorios — PRODLIST indústria (CNAE/NCM mapping).
...
ZONE = "raw"
TABLE = "prodlist_industria"

SOURCE_XLSX_NAME = "prodlist_industria.xlsx"
# Original xlsx ships next to this module; we stage it into tmp_data/.../input/.
