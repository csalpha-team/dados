"""Raw flow: IBGE PAC — tabela 1407 (Pesquisa Anual de Comércio).

Source: IBGE Agregados API, table 1407.
Lands one row per (regiao, comercio, ano, variavel) into ``$DB_RAW_ZONE.al_ibge_pac.tbl_1407``.
"""
...
DATASET_ID = "al_ibge_pac"
ZONE = "raw"
TABLE = "tbl_1407"

URL = (
    "https://servicodados.ibge.gov.br/api/v3/agregados/1407/periodos/{}/variaveis/"
    "368|312|314|503|866?localidades=N1[all]&classificacao=12354[all]|11066[all]"
)
YEAR_START = 2007
YEAR_END = 2024
...
def extract() -> pd.DataFrame:
    log.info("extract.api.start", agregado="1407", years=f"{YEAR_START}-{YEAR_END - 1}")
    parsed = []
