"""Raw flow: IBGE Censo Agropecuário 2017 — tabela 6898 (tipo de produção por tipo agricultura).

Source: IBGE Agregados API, agregado 6898, periodo 2017.
Lands rows into ``$DB_RAW_ZONE.al_ibge_censoagro.tbl_6898_2017``.
"""
