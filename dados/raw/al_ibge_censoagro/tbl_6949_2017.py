"""Raw flow: IBGE Censo Agropecuário 2017 — tabela 6949 (produto por tipo agricultura).

Source: IBGE Agregados API, agregado 6949, periodo 2017.
Lands rows into ``$DB_RAW_ZONE.al_ibge_censoagro.tbl_6949_2017``.
"""
...
AGREGADO = "6949"
PERIODOS = "2017"
VARIAVEIS = "|".join(["10071", "144", "10072", "145", "10073"])
NIVEL_GEOGRAFICO = "N6"
CLASSIFICACAO = "229[all]|829[all]"
ID_PRODUTO_CLASSIFICACAO = "229"
ID_TIPO_AGRICULTURA_CLASSIFICACAO = "829"
NOME_VARIAVEL_QUANTIDADE = "Quantidade produzida na extração vegetal"
