"""Raw flow: IBGE Censo Agropecuário 2006 — tabela 2518 (destinação produção, PA).

Source: IBGE Agregados API, agregado 2518, periodo 2006. Restrict to Pará.
Lands rows into ``$DB_RAW_ZONE.al_ibge_censoagro.tbl_2518_2006``.
"""
...
PERIODOS = "2006"
VARIAVEIS = "|".join(
    ["2381", "2382", "2384", "2383", "2390", "2385", "2386", "2387", "2388", "2389"]
)
NIVEL_GEOGRAFICO = "N6"
