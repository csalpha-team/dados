...
if __name__ == "__main__":
    ...
    for file in tqdm.tqdm(files):
        ...
        with open(f"../tmp/{nome_tabela}/{file}", "r") as f:
            ...
            tbl = parse_agrocenso_json(data, id_produto='210', id_tipo_agricultura='12896')
    ...
    with PostgresETL(
        ...
        schema='al_ibge_censoagro') as db:
            ...
            db.create_table('tbl_1909_2006', columns, if_not_exists=True)
            
            db.load_data('tbl_1909_2006', df, if_exists='replace')
