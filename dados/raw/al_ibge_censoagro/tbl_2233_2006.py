"""Raw flow: IBGE Censo Agropecuário 2006 — tabela 2233 (destinação da produção, PA).

Source: IBGE Agregados API, agregado 2233, periodo 2006. Restrict to Pará.
Lands rows into ``$DB_RAW_ZONE.al_ibge_censoagro.tbl_2233_2006``.
"""
...
NOME_VARIAVEL_QUANTIDADE = "Quantidade colhida"
