"""Raw flow: IBGE Censo Agropecuário 2006 — tabela 1931 (tipo de produção por tipo de agricultura).

Source: IBGE Agregados API, agregado 1931, periodo 2006.
Lands rows into ``$DB_RAW_ZONE.al_ibge_censoagro.tbl_1931_2006``.
"""
...
NIVEL_GEOGRAFICO = "N6"
CLASSIFICACAO = "12547[all]|12896[all]"
ID_PRODUTO_CLASSIFICACAO = "12547"
...
def extract() -> pd.DataFrame:
    ...
    df = df.rename(columns={"id_produto": "id_tipo_producao", "produto": "tipo_producao"})
    return df
