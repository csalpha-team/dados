"""Raw flow: IBGE Censo Agropecuário 2017 — tabela 6899 (despesas por tipo agricultura).

Source: IBGE Agregados API, agregado 6899, periodo 2017.
Lands rows into ``$DB_RAW_ZONE.al_ibge_censoagro.tbl_6899_2017``.
"""
...
AGREGADO = "6899"
PERIODOS = "2017"
VARIAVEIS = "|".join(["2", "1996"])
NIVEL_GEOGRAFICO = "N6"
CLASSIFICACAO = "210[all]|829[all]"
