"""Raw flow: IBGE Censo Agropecuário 2017 — tabela 6885 (faixa de idade por tipo agricultura).

Source: IBGE Agregados API, agregado 6885, periodo 2017.
Lands rows into ``$DB_RAW_ZONE.al_ibge_censoagro.tbl_6885_2017``.
"""
...
PERIODOS = "2017"
VARIAVEIS = "|".join(
    ["10099", "185", "2052", "2002", "2053", "2003", "9543", "9544", "9545"]
)
NIVEL_GEOGRAFICO = "N6"
CLASSIFICACAO = "829[all]|223[all]"
ID_PRODUTO_CLASSIFICACAO = "223"
...
def extract() -> pd.DataFrame:
    ...
    df = df.rename(columns={"id_produto": "id_faixa_idade", "produto": "faixa_idade"})
    return df
