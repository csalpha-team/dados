"""Raw flow: IBGE PIA — tabela 1848 (Pesquisa Industrial Anual, UF).

Source: IBGE Agregados API, table 1848 (2007-2022, CNAE 12762).
Lands one row per (UF, categoria, ano, variavel) into
``$DB_RAW_ZONE.br_ibge_pia.tbl_1848``.
"""
...
URL = (
    "https://servicodados.ibge.gov.br/api/v3/agregados/1848/periodos/"
...
def extract() -> pd.DataFrame:
    log.info("extract.api.start", agregado="1848")
