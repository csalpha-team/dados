"""Raw flow: IBGE PIA — tabela 1987 (Pesquisa Industrial Anual, UF, série antiga).

Source: IBGE Agregados API, table 1987 (1996-2007, CNAE 11939).
...
URL = (
    "https://servicodados.ibge.gov.br/api/v3/agregados/1987/periodos/"
...
def extract() -> pd.DataFrame:
    log.info("extract.api.start", agregado="1987")
